...
api_key = 'VYb4xkjABa9tOsfBmHK2P6vCrDfg64ASjggIlKNB'
...
url = query_fmt % (api_key, location)
...
while len(fs_list) < nresults:
    ...
    offset = len(fs_list)
    url_offset = url+'&offset=%s' % (offset)   
    ...
    fs_list.extend(data[u'fuel_stations'])
